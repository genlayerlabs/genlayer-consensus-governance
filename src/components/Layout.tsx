...
export function Layout() {
  ...
  return <div className="app-shell">
    <header className="header">
      ...
      <nav><NavLink to="/">Proposals</NavLink><NavLink to="/create">Create proposal</NavLink><NavLink to="/delegates">Delegation</NavLink><NavLink to="/council">Security Council</NavLink><NavLink to="/elections">Elections</NavLink></nav>
